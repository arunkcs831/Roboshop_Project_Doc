...
It is advantageous of systemctl managing services, Hence we are taking that approach. Which is also a standard way in the OS.
...
Create file by using **`vim /etc/systemd/system/shipping.service`**
